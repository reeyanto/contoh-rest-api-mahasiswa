                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nim" value="{{ old('nim', $mahasiswa->nim) }}" autocomplete="off" readonly class="form-control bg-light @error('nim') is-invalid @enderror" placeholder="Nomor Induk Mahasiswa">
                                        @error('nim')
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama" value="{{ old('nama', $mahasiswa->nama) }}" autocomplete="off" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama Mahasiswa">
                                        @error('nama')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" id="alamat" rows="3" autocomplete="off" class="form-control" style="resize: none" placeholder="Alamat">{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                                        @error('alamat')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
