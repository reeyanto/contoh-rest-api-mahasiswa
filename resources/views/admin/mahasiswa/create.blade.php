                    ...
                    <div class="card-body">
                        <form action="{{ route('mahasiswa.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nim" value="{{ old('nim') }}" autocomplete="off" class="form-control @error('nim') is-invalid @enderror">
                                @error('nim')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" value="{{ old('nama') }}" autocomplete="off" class="form-control @error('nama') is-invalid @enderror">
                                @error('nama')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" id="alamat" rows="3" autocomplete="off" class="form-control" style="resize: none">{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
